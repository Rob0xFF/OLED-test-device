...
*/
/**************************************************************************/
boolean Adafruit_FT6206::begin(uint8_t thresh, uint8_t irq_mode) {
  Wire.begin();
  ...
  Serial.println(readRegister8(FT62XX_REG_THRESHHOLD));
    Serial.print("IRQ Mode: "); 
	Serial.println(readRegister8(FT62XX_REG_IRQ_MODE));
  ...
  // set IRQ mode
  writeRegister8(FT62XX_REG_IRQ_MODE, irq_mode);	
